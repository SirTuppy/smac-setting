...
export const FUN_MESSAGES: FunMessage[] = [
    { text: "Please do not feed the setters" },
    { text: "Interior crocodile alligator, I set routes in my climbing gym later" },
    { text: "Crimps to the left of me, slopers to the right, here I am, stuck in the middle with you" },
    { text: "You either die a hero, or live long enough to see yourself set USAC comps" },
    { text: "It's not about the grade… it's about sending a message" },
    { text: "This is not a drill" },
    { text: "Ceci n'est pas un art" },
    { text: "Dibs on jibs" },
    { text: "This is a test of the emergency route setting system" },
    { text: "Dammit Jim I'm a routesetter not a doctor" },
    { text: "They're taking the screw-ons to Isengard!" },
    { text: "Grades are a social construct" },
    { text: "This dashboard will not save you" },
    { text: "One must imagine the climber happy" },
    { text: "We are condemned to forerun" },
    { text: "With great power comes great morphology" },
    { text: "Not all who wander are off-route" },
    { text: "Fortune favors the hold" },
    {
        text: "Don't click the little button there ->",
        isLongStory: true,
        content: `NATE THE SNAKE
