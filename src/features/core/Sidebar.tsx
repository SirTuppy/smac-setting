...
import {
    ...
    TrendingUp, LineChart, Gauge, Moon, Sun
} from 'lucide-react';
        ...
        <aside className="w-72 bg-[#00205B] text-white flex flex-col fixed inset-y-0 left-0 z-50 shadow-2xl">
            ...
            <div className="p-6 border-b border-white/10">
                <div className="flex items-center gap-3 mb-1" id="tour-brand">
                    <div 
                        className="flex items-center justify-center p-1 cursor-pointer active:scale-95 transition-transform"
            ...
            {/* Mission Control */}
                <div>
                    <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em] mb-4 px-2">Home</p>
                    <div className="grid grid-cols-1 gap-1">
                        <button
                            id="nav-mission-control"
                            onClick={() => setActiveView('mission-control')}
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeView === 'mission-control'
                                ? 'bg-white/10 text-white shadow-inner border border-white/10'
                                : 'text-white/40 hover:bg-white/5 hover:text-white/60'
                                }`}
                        >
                            <Compass size={18} style={{ color: activeView === 'mission-control' ? '#009CA6' : undefined }} />
                            <span className="text-xs font-black uppercase tracking-widest">Mission Control</span>
                        </button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 gap-1">
                        ...
                        {/* <button
                            id="nav-setter-path"
                            onClick={() => setActiveView('setter-path')}
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeView === 'setter-path'
                                ? 'bg-white/10 text-white shadow-inner border border-white/10'
                                : 'text-white/40 hover:bg-white/5 hover:text-white/60'
                                }`}
                        >
                            <Target size={18} style={{ color: activeView === 'setter-path' ? '#009CA6' : undefined }} />
                            <span className="text-xs font-black uppercase tracking-widest text-left">The Setter's Path</span>
                        </button> */}
            ...
            <div className="p-4 bg-black/20 border-t border-white/5">
                ...
                <div className="mt-6 flex flex-col gap-4 px-2">
                    {/* Dark Mode Toggle - Expanded Visibility */}
                    <div className="flex items-center justify-between bg-black/30 p-1.5 rounded-full border border-white/5">
                        <button
                            onClick={() => isDarkMode && toggleDarkMode()}
                            className={`flex-1 flex items-center justify-center gap-2 py-1.5 rounded-full transition-all text-[10px] font-black uppercase tracking-widest ${!isDarkMode
                                ? 'bg-[#009CA6] text-white shadow-lg'
                    ...
                    <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-[0.4em] text-white/20">
                        <button 
                            className="hover:text-[#009CA6] transition-colors cursor-help"
